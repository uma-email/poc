...
There is no contract between security domains foo.com and bar.com. This concept uses an UMA-based challenge–response authentication with a correlation handle.
