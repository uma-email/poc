...
AEMS provides a mechanism to store, share and transfer information accross network and security domains. From the user's point of view, AEMS looks like a standard email system.
