...
The requesting party and the resource owner may use mutually isolated instances of the authorization server residing on different domains. This concept uses a permission ticket as a correlation handler between two authorization processes and an e-mail address as a unique requesting party identifier for identity-based access control.
