...
There is no need to have a relationship between security domains foo.com and bar.com. The RqP Client should be a pre-registered on Authorization Server as a public client. This concept uses an UMA-based challenge–response authentication with a correlation handle.
